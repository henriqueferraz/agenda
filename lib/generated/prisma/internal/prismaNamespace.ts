/**
 * Utilitario - PrismaNamespace
 *
 * Visao geral:
 * - Funcoes de suporte para PrismaNamespace.
 *
 * Fluxo de execucao:
 ...
 * ## Exemplo de uso
 * ```typescript
 * import * as modulo from "@/lib/generated/prisma/internal/prismaNamespace";
 *
...
export type GetHavingFields<T> = {
    ...
    T[K] extends infer TK ? GetHavingFields<UnEnumerate<TK> extends object ? Merge<UnEnumerate<TK>> : never> : never : {} extends FieldPaths<T[K]> ? never : K;
}[keyof T];
/**
...
export const defineExtension = runtime.Extensions
    .defineExtension as unknown as runtime.Types.Extensions.ExtendsHook<'define', TypeMapCb, runtime.Types.Extensions.DefaultArgs>;
