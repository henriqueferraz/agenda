 ...
 *
 * Visao geral:
 * - Funcoes de suporte para Address.
 *
 * Fluxo de execucao:
 ...
 * ## Exemplo de uso
 * ```typescript
 * import * as modulo from "@/lib/generated/prisma/models/Address";
 *
...
export type AddressOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<'id' | 'street' | 'number' | 'complement' | 'neighborhood' | 'city' | 'state' | 'zip_code' | 'country' | 'UserId' | 'createdAt' | 'updatedAt', ExtArgs['result']['address']>;
