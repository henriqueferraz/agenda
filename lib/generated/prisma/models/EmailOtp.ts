 ...
 *
 * Visao geral:
 * - Funcoes de suporte para EmailOtp.
 *
 * Fluxo de execucao:
 ...
 * ## Exemplo de uso
 * ```typescript
 * import * as modulo from "@/lib/generated/prisma/models/EmailOtp";
 *
...
type GetEmailOtpGroupByPayload<T extends EmailOtpGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<EmailOtpGroupByOutputType, T['by']> & {
...
export type EmailOtpWhereInput = {
    ...
    lockedUntil?: Prisma.DateTimeNullableFilter<'EmailOtp'> | Date | string | null;
    ...
    userId?: Prisma.StringNullableFilter<'EmailOtp'> | string | null;
...
export type EmailOtpScalarWhereWithAggregatesInput = {
    ...
    lockedUntil?: Prisma.DateTimeNullableWithAggregatesFilter<'EmailOtp'> | Date | string | null;
    ...
    userId?: Prisma.StringNullableWithAggregatesFilter<'EmailOtp'> | string | null;
};
...
export type EmailOtpUpdateInput = {
    ...
    user?: Prisma.UserUpdateOneWithoutEmailOtpsNestedInput;
};
...
export type EmailOtpOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<'id' | 'email' | 'codeHash' | 'expiresAt' | 'usedAt' | 'attempts' | 'lockedUntil' | 'lastSentAt' | 'createdAt' | 'updatedAt' | 'userId', ExtArgs['result']['emailOtp']>;
...
export interface EmailOtpFieldRefs {
    ...
    readonly lockedUntil: Prisma.FieldRef<'EmailOtp', 'DateTime'>;
