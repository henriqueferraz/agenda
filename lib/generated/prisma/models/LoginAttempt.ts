/**
 * Utilitario - LoginAttempt
 *
 * Visao geral:
 * - Funcoes de suporte para LoginAttempt.
 *
 * Fluxo de execucao:
 ...
 * ## Exemplo de uso
 * ```typescript
 * import * as modulo from "@/lib/generated/prisma/models/LoginAttempt";
 *
...
export type LoginAttemptWhereInput = {
    ...
    lastAttempt?: Prisma.DateTimeFilter<'LoginAttempt'> | Date | string;
...
export type LoginAttemptScalarWhereWithAggregatesInput = {
    ...
    lastAttempt?: Prisma.DateTimeWithAggregatesFilter<'LoginAttempt'> | Date | string;
...
export type LoginAttemptOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<'id' | 'email' | 'count' | 'lastAttempt' | 'lockedUntil' | 'createdAt' | 'updatedAt', ExtArgs['result']['loginAttempt']>;
...
export interface LoginAttemptFieldRefs {
    ...
    readonly lastAttempt: Prisma.FieldRef<'LoginAttempt', 'DateTime'>;
