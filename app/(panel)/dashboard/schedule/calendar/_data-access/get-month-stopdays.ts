/**
 * Data Access - Get Month Stopdays
 *
 * Visao geral:
 * - Consulta de dados para Get Month Stopdays.
 *
 * Fluxo de execucao:
 ...
 * ## Exemplo de uso
 * ```typescript
 * import * as modulo from "@/app/(panel)/dashboard/schedule/calendar/_data-access/get-month-stopdays";
 *
