/**
 * Data Access - Get Calendar Data
 *
 * Visao geral:
 * - Consulta de dados para Get Calendar Data.
 *
 * Fluxo de execucao:
 ...
 * ## Exemplo de uso
 * ```typescript
 * import * as modulo from "@/app/(panel)/dashboard/schedule/calendar/_data-access/get-calendar-data";
 *
