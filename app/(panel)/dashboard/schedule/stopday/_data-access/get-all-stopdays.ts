/**
 * Data Access - Get All Stopdays
 *
 * Visao geral:
 * - Consulta de dados para Get All Stopdays.
 *
 * Fluxo de execucao:
 ...
 * ## Exemplo de uso
 * ```typescript
 * import * as modulo from "@/app/(panel)/dashboard/schedule/stopday/_data-access/get-all-stopdays";
 *
